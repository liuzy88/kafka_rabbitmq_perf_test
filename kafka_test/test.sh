...
T="/SERVICE01/kafka_0821/bin/kafka-topics.sh --create --zookeeper zk1:2181,zk2:2181,zk3:2181"
P="/SERVICE01/kafka_0821/bin/kafka-producer-perf-test.sh --messages 500000"
C="/SERVICE01/kafka_0821/bin/kafka-consumer-perf-test.sh --zookeeper zk1:2181,zk2:2181,zk3:2181 --messages 5000000"
